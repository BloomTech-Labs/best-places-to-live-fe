...
export class MapContainer extends Component {
  ...
  render() {
    ...
    let currentPlace =
      this.state.selectedPlace && this.state.activeMarker
        ? this.state.cities[this.state.activeMarker.activeid]
        : null;
          ...
          >
            <div>
              {currentPlace ? (
                <div
                  style={{
                    width: this.props.zoom + "vw",
                    minWidth: "300px",
                    margin: "0 auto"
                  }}
                  onClick={() => this.props.histor.push()}
                  style={{
                    display: "flex",
                ...
                >
                  <a href={"/city/?id=" + currentPlace.id}>
                    <h4>{currentPlace.short_name}</h4>
                  </a>
                  <GraphView
